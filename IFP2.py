...
mapa_fatores = {
    'Assistência': [9, 44, 47, 58, 73, 77, 89, 98], 'Intracepção': [18, 22, 25, 60, 67, 87, 90],
    'Afago': [17, 29, 31, 53, 54, 56, 97], 'Deferência': [6, 15, 28, 48, 49, 50, 68, 82, 83],
    'Afiliação': [19, 26, 34, 37, 46, 52, 57, 64, 66], 'Dominância': [11, 35, 45, 62, 65, 75, 81],
    'Desempenho': [2, 7, 12, 32, 33, 38, 80, 84, 86], 'Exibição': [61, 71, 72, 85, 88, 93, 96, 99, 100],
    'Agressão': [23, 24, 39, 70, 76], 'Ordem': [30, 51, 55, 78, 94, 95],
    'Persistência': [8, 10, 14, 16, 20, 27, 36, 42], 'Mudança': [3, 13, 21, 41, 43, 59, 79],
